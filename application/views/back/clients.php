...
<body class="animsition">
    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <!-- END HEADER DESKTOP-->
            <?php include("part/drop/dropAjoutClients.php") ?>
            <?php include("part/drop/dropModifClients.php") ?>
            <!-- MAIN CONTENT-->
                                    ...
                                    <table id="tableau" class="table table-data2 sortable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                   <a href="<?php echo base_url()?>Back-ToModifClient-<?php echo $client['idclient'];?>-<?php echo $client['nom'];?>">
                                                ...
                                                <td>
                                                  <a href="<?php echo base_url()?>Delete-Client-<?php echo $client['idclient'];?>"><button class="btn btn-danger btn-sm" type="button">
