...
<h5 class="modal-title" id="mediumModalLabel">Ajout Categorie</h5>
...
<div class="card">
               <div class="card-header">Ajout de Categorie</div>
               <div class="card-body">

                   <hr>
                   <form action="<?php echo base_url()?>Back-AddCategorie" method="post" novalidate="novalidate">
