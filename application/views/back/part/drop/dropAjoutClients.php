...
<h5 class="modal-title" id="mediumModalLabel">Ajout Client</h5>
...
<div class="card">
               <div class="card-header">Ajout de Client</div>
               <div class="card-body">

                   <hr>
                   <form action="<?php echo base_url()?>Back-AddClient" method="post" novalidate="novalidate">
                       ...
                       <div class="form-group has-success">
                           ...
                           <input id="login" name="login" type="text" class="form-control cc-name valid" data-val="true" required>
