...
<head>
    ...
    <!-- Title Page-->
    <title>Modfication Client</title>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                               ...
                                               <div class="card-body">
                                                   ...
                                                   <hr>
                                                   <form action="<?php echo base_url()?>Back-ModifClient" method="post" novalidate="novalidate">
                                                      ...
                                                      <a href="<?php echo base_url()?>/index.php/BackControl/toCategories">
